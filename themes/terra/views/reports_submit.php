	...
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div class="report_right">
				...
				<div class="report_row">
					<h4><?php echo Kohana::lang('ui_main.reports_find_location'); ?> <span class="required">*</span></h4>
					<?php print form::dropdown('select_city',$cities,'', ' class="select" '); ?> &nbsp;&nbsp;or drag and drop the marker:
				</div>
				<?php } ?>
				<div class="report_row">
